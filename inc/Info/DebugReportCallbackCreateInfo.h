#ifndef __VKPP_INFO_DEBUG_REPORT_CALLBACK_CREATE_INFO_H__
#define __VKPP_INFO_DEBUG_REPORT_CALLBACK_CREATE_INFO_H__
...
StaticSizeCheck(DebugReportCallbackCreateInfo);
...
#endif              // __VKPP_INFO_DEBUG_REPORT_CALLBACK_CREATE_INFO_H__
