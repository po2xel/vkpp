...
enum class Structure
{
    ...
    eMemoryAllocate             = VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO,
    eMappedMemoryRange          = VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE,
    eBindSparse                 = VK_STRUCTURE_TYPE_BIND_SPARSE_INFO,
    eFence                      = VK_STRUCTURE_TYPE_FENCE_CREATE_INFO,
    eSemaphore                  = VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO,
    eEvent                      = VK_STRUCTURE_TYPE_EVENT_CREATE_INFO,
    eQueryPool                  = VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO,
    ...
    eSampler                    = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO,
    eDescriptorSetLayout        = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO,
    eDescriptorPool             = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO,
    eDescriptorSetAllocate      = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO,
    ...
    eLoaderInstance             = VK_STRUCTURE_TYPE_LOADER_INSTANCE_CREATE_INFO,
    eLoaderDevice               = VK_STRUCTURE_TYPE_LOADER_DEVICE_CREATE_INFO,
