...
class IndexedTriangle : public Application
{
private:
...
public:
    IndexedTriangle(const char* apApplicationName, uint32_t aApplicationVersion, const char* apEngineName = nullptr, uint32_t aEngineVersion = 0);
    virtual ~IndexedTriangle(void);
};
