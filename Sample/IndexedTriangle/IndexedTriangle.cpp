...
IndexedTriangle::IndexedTriangle(const char* apApplicationName, uint32_t aApplicationVersion, const char* apEngineName, uint32_t aEngineVersion)
...
IndexedTriangle::~IndexedTriangle(void)
{
    mLogicalDevice.Wait();
...
void IndexedTriangle::CreateCommandPool(void)
{
...
void IndexedTriangle::CreateRenderingResources(void)
{
    for(auto& lRenderingResource : mRenderingResources)
    {
...
void IndexedTriangle::AllocateCommandBuffers(vkpp::CommandBuffer& aCommandBuffer) const
{
...
void IndexedTriangle::CreateSemaphore(vkpp::Semaphore& aSemaphore) const
{
...
void IndexedTriangle::CreateFence(vkpp::Fence& aFence) const
{
...
void IndexedTriangle::CreateRenderPass(void)
{
...
void IndexedTriangle::CreatePipeline(void)
{
...
void IndexedTriangle::CreateVertexBuffer(void)
{
    vkpp::BufferCreateInfo lVertexBufferCreateInfo
    {
        sizeof(gVertexData), vkpp::BufferUsageFlags(vkpp::BufferUsageFlagBits::eVertexBuffer) | vkpp::BufferUsageFlagBits::eTransferDst
...
void IndexedTriangle::CreateIndexBuffer(void)
{
...
void IndexedTriangle::CopyBuffer(vkpp::Buffer& aDstBuffer, const vkpp::Buffer& aSrcBuffer, vkpp::DeviceSize aSize) const
{
...
vkpp::DeviceMemory IndexedTriangle::AllocateBufferMemory(const vkpp::Buffer& aBuffer, const vkpp::MemoryPropertyFlags& aMemoryProperties) const
{
...
vkpp::Framebuffer IndexedTriangle::CreateFramebuffer(const vkpp::ImageView& aImageView) const
{
...
void IndexedTriangle::PrepareFrame(vkpp::Framebuffer& aFramebuffer, const vkpp::CommandBuffer& aCommandBuffer, const vkpp::ImageView& aImageView) const
{
    if (aFramebuffer)
...
void IndexedTriangle::DrawFrame(void)
{
