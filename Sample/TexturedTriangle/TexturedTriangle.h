...
class TexturedTriangle : public Application
{
private:
...
public:
    TexturedTriangle(const char* apApplicationName, uint32_t aApplicationVersion, const char* apEngineName = nullptr, uint32_t aEngineVersion = 0);
    virtual ~TexturedTriangle(void);
};
